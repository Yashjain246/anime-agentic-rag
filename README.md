...
> Set the OAuth app's publishing status to **In production** before running this —
> in "Testing" mode Google expires the refresh token after 7 days. See
> [DEPLOYMENT.md](DEPLOYMENT.md#step-3--google-calendar-setup-optional).
